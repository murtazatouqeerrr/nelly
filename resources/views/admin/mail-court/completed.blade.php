...
<head>
    ...
    <title>Delivered Mailings</title>
...
<body>
    ...
    <div class="container-fluid mt-4" style="margin-left: 280px; max-width: calc(100% - 300px);">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-check-circle"></i> Delivered</h2>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $mailing->delivered_at?->format('M d, Y') }}</td>
                                <td>
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="text-center text-muted py-4">No delivered mailings</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
