...
<body>
    ...
    <div class="container-fluid mt-4" style="margin-left: 280px; max-width: calc(100% - 300px);">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-map-marker-alt"></i> Revenue by State</h2>
            <div class="btn-group">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <h3 class="mb-0">{{ count($byState) }}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Revenue Breakdown by State</h5>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach($byState as $state)
                                <tr>
                                    ...
                                    <td class="text-end">{{ number_format($state['count']) }}</td>
                                    <td class="text-end">${{ number_format($state['revenue'] / $state['count'], 2) }}</td>
                                    <td class="text-end">{{ number_format(($state['revenue'] / $stats['net_revenue']) * 100, 1) }}%</td>
                                </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
