...
<head>
    ...
    <title>Expired Enrollments</title>
...
<body>
    ...
    <div class="mb-6 flex justify-between items-center">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Expired Enrollments</h1>
            <p class="text-gray-600 mt-2">Enrollments that expired in the last {{ $daysAgo }} days</p>
        </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Expired On</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4">{{ $enrollment->updated_at?->format('M d, Y') }}</td>
                    <td class="px-6 py-4"><a href="{{ route('admin.enrollments.edit', $enrollment->id) }}" class="text-blue-600 hover:text-blue-900">View</a></td>
                </tr>
                @empty
                <tr><td colspan="5" class="px-6 py-4 text-center text-gray-500">No expired enrollments found</td></tr>
                @endforelse
            </tbody>
        </table>
