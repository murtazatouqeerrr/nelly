...
class DicdsUser extends Authenticatable
{
    ...
    public function isProviderAdmin() { return $this->desired_role === 'DRS_Provider_Admin'; }
    public function isProviderUser() { return $this->desired_role === 'DRS_Provider_User'; }
    public function isSchoolAdmin() { return $this->desired_role === 'DRS_School_Admin'; }
}
