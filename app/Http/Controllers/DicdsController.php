...
use App\Models\{DicdsUser, School, Course, Certificate, Instructor, SchoolCourse, InstructorCourse, FloridaCourse, FloridaSchool};
use Illuminate\Http\Request;

class DicdsController extends Controller
{
    public function mainMenu() { return view('dicds.main-menu'); }
    public function welcome() { return view('dicds.welcome'); }
    public function providerMenu() { return view('dicds.provider-menu'); }

    // School Management
    public function addSchool() { return view('dicds.schools.add'); }
    ...
    public function certificateReports() { return view('dicds.reports.menu'); }

    public function certificateLookup() { return view('dicds.reports.certificate-lookup'); }
    ...
    public function webServiceInfo() { return view('dicds.reports.web-service-info'); }
}
