...
{
    public function showLogin() { return view('dicds.login'); }
    ...
    public function showRegister() { return view('dicds.register'); }
    ...
    public function showAccessRequest() { return view('dicds.access-request'); }
